...
async function setupRegistryItems() {
  ...
  console.log('═══════════════════════════════════════════════════════════\n');
    ...
    // STEP 1: Install design tokens from Focus registry
    console.log('📦 STEP 1: Installing design tokens from @focus registry...');
    ...
    try {
      ...
      console.log('\n✅ Design tokens installed successfully\n');
    } catch (error) {
  ...
  console.log('   3. Edit: tokens/base.json (Customize theme)');
}
